...
- **Degrees of freedom:** Roll (theta) and Pitch (ϕ).  
- **State vector** (indices, symbols, units):  

| Index | Symbol | Description | Unit |
|-------|--------|-------------|------|
| 0     | theta      | Roll angle / displacement | rad |
| 1     | ϕ      | Pitch angle / displacement | rad |
| 2     | omegatheta    | Roll angular velocity | rad/s |
| 3     | omegaϕ    | Pitch angular velocity | rad/s |
| 4     | deltae     | Electric thruster torque command (control input) | N.m |
...
| **Robust - Sliding Mode / Hinf** | Provides guaranteed stability for uncertain wave forces and wind variability; useful if external excitations are poorly characterized. May cause chattering at thruster limits, mitigated by a smoothness filter. |
