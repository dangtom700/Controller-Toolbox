...
**Reference (plant model):** R.D. Bell, K.J. Astrom (1987). "A Low Order Nonlinear Dynamic Model of a Power Plant Boiler-Turbine Unit." Lund Institute of Technology Report.
...
|-------|--------|-------------|------|
| x1 | p | Drum pressure | kg/cm^2 (~bar) |
| x2 | P_e | Electric power output | MW |
| x3 | rho | Fluid density in drum | kg/cm^3 |
...
| OP | Load Level | p [kg/cm^2] | P_e [MW] | rho [kg/cm^3] | u1 | u2 | u3 |
|----|-----------|------------|----------|--------------|----|----|-----|
