"""main.py - entry point for Aircraft Engine Thermal Management (TEMPLATE).
...
def main():
    ...
    from aircraft_engine_thermal_management_plant import Plant                      # noqa: E402
    ...
    print("Aircraft Engine Thermal Management: %d controllers x %d scenarios" % (len(controllers), len(scenarios)))
