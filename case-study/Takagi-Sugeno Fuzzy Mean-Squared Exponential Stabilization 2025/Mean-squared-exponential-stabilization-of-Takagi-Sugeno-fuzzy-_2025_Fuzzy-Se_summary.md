...
- **Limitation:** Computational load of MPC (approx =0.5 ms per step on a 1 GHz CPU) is a minor issue but can be mitigated with faster solvers or reduced prediction horizon for real-time deployment.
