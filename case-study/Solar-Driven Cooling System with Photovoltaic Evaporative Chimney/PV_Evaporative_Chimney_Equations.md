...
| $\beta_\text{ref}$ | 0.0044 °C$^{-1}$ | Manufacturer |
| $T_\text{ref}$ | 25 °C | Standard |
| $G_\text{ref}$ | 1000 W m$^{-2}$ | Standard |
| $T_\text{NOCT}$ | 47 °C | Manufacturer |
| $T_\text{ref,NOCT}$ | 20 °C | Standard |
...
| $T_{w2,\text{evap}}$ | 7 °C |
| $Q$ (optimal) | 1.05 m³ h$^{-1}$ |

### Parametric Analysis Range (Table 5)

| $T_\text{amb}$ (°C) | $\phi_\text{amb}$ (%) | $G$ (W m$^{-2}$) | $v_w$ (m s$^{-1}$) |
|---|---|---|---|
| 25 | 25 | 250 | 2.5 |
| 30 | 50 | 500 | 5 |
| 35 | 75 | 750 | 7.5 |
