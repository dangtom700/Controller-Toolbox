"""main.py - entry point for PCM Thermal Energy Storage Control (TEMPLATE).
...
def main():
    ...
    from pcm_thermal_energy_storage_control_plant import Plant                      # noqa: E402
    ...
    print("PCM Thermal Energy Storage Control: %d controllers x %d scenarios" % (len(controllers), len(scenarios)))
