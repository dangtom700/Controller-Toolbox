...
| Inertia about roll axis | $I_r$ | 5.2 * 10⁹ kg.m^2 | Hydrodynamic model |
...
4. **Robust / adaptive (e.g., sliding-mode, tube MPC, Hinf)**  
...
|----|----------------------|----------------|
| S1 | Baseline steady-state test at 0 kn, no wave input. | Reference roll angle = 0^\circ, $\nu = 0$ m/s |
...
- **Main quantitative findings:**  
  - LQR achieved < 1.5 s settling for S2, but saturated at approx = 30 kn wave height.  
