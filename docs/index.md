...
| [docs/fusion_opportunity_backlog.md](fusion_opportunity_backlog.md) | Ranked backlog of feasible controller fusions from existing `lib/` parts, sized for incremental pickup; includes assessed-and-rejected ideas and the demo-design pitfalls found building `ex131`-`ex135` |
| [docs/server_plc_fusion_plan.md](server_plc_fusion_plan.md) | Server/PLC master-slave controller fusions - `NetworkChannel` + 4 `ex131`-`ex134` demos, all passing; Stages 0/1a/2/3 done, 1b (bindings) and 4 open |
