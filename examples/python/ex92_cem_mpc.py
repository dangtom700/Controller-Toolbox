"""
ex92_cem_mpc.py -- Cross-Entropy Method MPC demo.
...
print("=== ex92: CEM-MPC on Double Integrator ===")
...
_pid_p.Kp = 10.0; _pid_p.Ki = 2.0; _pid_p.Kd = 0.5
_pid_p.N = 10.0; _pid_p.uMin = -5.0; _pid_p.uMax = 5.0
