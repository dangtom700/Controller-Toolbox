"""
ex88_cbf_safety.py -- Control Barrier Function (CBF) safety filter demo.
...
# ---------------------------------------------------------------------------
_pid_p = ctrl.PIDParams()
_pid_p.Kp = 8.0; _pid_p.Ki = 2.0; _pid_p.Kd = 0.0
_pid_p.N = 10.0; _pid_p.uMin = -10.0; _pid_p.uMax = 10.0
pid = ctrl.DiscretePID(_pid_p, TS)
